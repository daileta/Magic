...
import static net.evan.magic.magic.MagicPlayerAttachments.ACTIVE_ABILITY_SLOT;
import static net.evan.magic.magic.MagicPlayerAttachments.BURNING_PASSION_ENGINE_HEART_AFTERIMAGE_ACTIVE;
import static net.evan.magic.magic.MagicPlayerAttachments.BURNING_PASSION_ENGINE_HEART_AFTERIMAGE_TIER;
import static net.evan.magic.magic.MagicPlayerAttachments.BURNING_PASSION_HEAT_TENTHS;
import static net.evan.magic.magic.MagicPlayerAttachments.BURNING_PASSION_HUD_NOTIFICATION;
import static net.evan.magic.magic.MagicPlayerAttachments.BURNING_PASSION_STAGE;
import static net.evan.magic.magic.MagicPlayerAttachments.BURNING_PASSION_STAGE_ACTIVE;
import static net.evan.magic.magic.MagicPlayerAttachments.BURNING_PASSION_STAGE_REMAINING_TICKS;
import static net.evan.magic.magic.MagicPlayerAttachments.CURRENT_MANA;
import static net.evan.magic.magic.MagicPlayerAttachments.DEPLETED_RECOVERY_MODE;
import static net.evan.magic.magic.MagicPlayerAttachments.DOMAIN_CLASH_ACTIVE;
import static net.evan.magic.magic.MagicPlayerAttachments.DOMAIN_CLASH_INSTRUCTION_VISIBILITY;
import static net.evan.magic.magic.MagicPlayerAttachments.DOMAIN_CLASH_PROGRESS;
import static net.evan.magic.magic.MagicPlayerAttachments.DOMAIN_CLASH_PROMPT_KEY;
import static net.evan.magic.magic.MagicPlayerAttachments.DOMAIN_SECONDARY_TIMER_SECONDS;
import static net.evan.magic.magic.MagicPlayerAttachments.DOMAIN_TIMER_ABILITY_ID;
import static net.evan.magic.magic.MagicPlayerAttachments.DOMAIN_TIMER_SECONDS;
import static net.evan.magic.magic.MagicPlayerAttachments.FROST_HIGHEST_UNLOCKED_STAGE;
import static net.evan.magic.magic.MagicPlayerAttachments.FROST_STAGE;
import static net.evan.magic.magic.MagicPlayerAttachments.FROST_STAGE_ACTIVE;
import static net.evan.magic.magic.MagicPlayerAttachments.FROST_STAGE_PROGRESS_TICKS;
import static net.evan.magic.magic.MagicPlayerAttachments.FROST_STAGE_REQUIRED_TICKS;
import static net.evan.magic.magic.MagicPlayerAttachments.GREED_COINS;
import static net.evan.magic.magic.MagicPlayerAttachments.MAGIC_SCHOOL;
import static net.evan.magic.magic.MagicPlayerAttachments.PLUS_ULTRA_ACTIVE;
import static net.evan.magic.magic.MagicPlayerAttachments.setAttachedIfChanged;
import static net.evan.magic.magic.MagicPlayerAttachments.target;
