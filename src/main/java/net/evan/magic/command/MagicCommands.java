						...
						CommandManager.literal("cooldown")
							.then(
								CommandManager.literal("reset")
									...
									.then(cooldownAbilityLiteral(MagicAbility.SEARING_DASH, "searing_dash"))
									.then(cooldownAbilityLiteral(MagicAbility.CINDER_MARK, "cinder_mark"))
									.then(cooldownAbilityLiteral(MagicAbility.ENGINE_HEART, "engine_heart"))
						...
						CommandManager.literal("ability")
							.then(
								CommandManager.literal("lock")
									...
									.then(abilityAccessLiteral(MagicAbility.SEARING_DASH, "searing_dash", true))
									.then(abilityAccessLiteral(MagicAbility.CINDER_MARK, "cinder_mark", true))
									.then(abilityAccessLiteral(MagicAbility.ENGINE_HEART, "engine_heart", true))
							...
							.then(
								CommandManager.literal("unlock")
									...
									.then(abilityAccessLiteral(MagicAbility.SEARING_DASH, "searing_dash", false))
									.then(abilityAccessLiteral(MagicAbility.CINDER_MARK, "cinder_mark", false))
									.then(abilityAccessLiteral(MagicAbility.ENGINE_HEART, "engine_heart", false))
